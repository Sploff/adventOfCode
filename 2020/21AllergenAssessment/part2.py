...
def safeIngredients():
    safeIngredientsList= []
    safeIngredientsList2= []
    for ingredient in ingredients:
        if ingredient not in safeIngredientsList:
            safeIngredientsList.append(ingredient)
    print(safeIngredientsList)
    safeIngredientsList.sort()
    print(safeIngredientsList)
    for ingredient in safeIngredientsList:
        safeIngredientsList2.append(ingredients[ingredient][0])
    print(str(safeIngredientsList2).replace(' ','').replace('\'',''))
